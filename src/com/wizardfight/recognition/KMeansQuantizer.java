...
public class KMeansQuantizer implements Serializable {// extends
    ...
    public void print() {
        System.out.println( trained + " " + featureDataReady + " " + initialized );
        System.out.println( numClusters + " " + minNumEpochs + " " + maxNumEpochs );
        System.out.println();
        System.out.println( numInputDimensions + " " + numOutputDimensions + " " + minChange);
        clusters.print();
        System.out.println();
        System.out.println( featureExtractionType + " " + classType);
        System.out.println( featureVector );
        System.out.println();
        System.out.println( quantizationDistances );
        System.out.println("===============================");
    }
}
